                ...
                <div class="col grid-full order-md-1 order-lg-2">
                    <div class="hiraola-slider_area">
                        <div class="main-slider">
                            ...
                            <div class="single-slide animation-style-01 bg-1 " style="background-image: url('{{asset($slider->image)}}')!important;">
{{--                             I want to show slider image but style property does not work --}}
                                <div class="container" >
                                    <div class="slider-content">
                                        <h5><span>{{$slider->offer_time}}</span> This Week</h5>
                                        <h2>{{$slider->title}}</h2>
                                        <h3>{{$slider->title_2}}</h3>
                                        <h4>Starting at <span>{{$slider->price}}</span></h4>
                                        <div class="hiraola-btn-ps_left slide-btn">
                                            <a class="hiraola-btn" href="{{route('shop')}}">Shopping Now</a>
                                        </div>
                                    </div>
...
{{--                slider end here --}}
{{--                trending best product start here --}}
                <div class="col grid-half grid-md_half order-md-2 order-lg-3">
                    <div class="banner-item img-hover_effect">
                        <a href="shop-left-sidebar.html">
                            <img class="img-full" src="{{asset('front-assets')}}/assets/images/banner/1_1.jpg" alt="Hiraola's Banner">
                        </a>
                    </div>
                </div>
{{--                trending best product start end here --}}
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                    <div class="banner-item img-hover_effect">
                        <a href="shop-left-sidebar.html">
                            <img class="img-full" src="{{asset('front-assets')}}/assets/images/banner/1_2.jpg" alt="Hiraola's Banner">
                        </a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="banner-item img-hover_effect">
                        <a href="shop-left-sidebar.html">
                            <img class="img-full" src="{{asset('front-assets')}}/assets/images/banner/1_3.jpg" alt="Hiraola's Banner">
                        </a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="banner-item img-hover_effect">
                        <a href="shop-left-sidebar.html">
                            <img class="img-full" src="{{asset('front-assets')}}/assets/images/banner/1_4.jpg" alt="Hiraola's Banner">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="tab-content hiraola-tab_content">
                        ...
                        <div id="earrings" class="tab-pane active show" role="tabpanel">
                            @foreach($earrings as $shop)
                            <div class="hiraola-product-tab_slider-2">
                                <!-- Begin Hiraola's Slide Item Area -->
                        ...
                        <div id="bracelet" class="tab-pane active show" role="tabpanel">
                            @foreach($bracelet as $shop)
                            <div class="hiraola-product-tab_slider-2">
                                <!-- Begin Hiraola's Slide Item Area -->
                        ...
                        <div id="anklet" class="tab-pane active show" role="tabpanel">
                            @foreach($anklet as $shop)
                            <div class="hiraola-product-tab_slider-2">
                                <!-- Begin Hiraola's Slide Item Area -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="banner-item img-hover_effect">
                        <a href="shop-left-sidebar.html">
                            <img class="img-full" src="{{asset('front-assets')}}/assets/images/banner/1_5.jpg" alt="Hiraola's Banner">
                        </a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="banner-item img-hover_effect">
                        <a href="shop-left-sidebar.html">
                            <img class="img-full" src="{{asset('front-assets')}}/assets/images/banner/1_6.jpg" alt="Hiraola's Banner">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="tab-content hiraola-tab_content">
                        ...
                        <div id="earrings-1" class="tab-pane active show" role="tabpanel">
                            @foreach($earrings as $shop)
                                <div class="hiraola-product-tab_slider-3">
                                    <!-- Begin Hiraola's Slide Item Area -->
                                    <div class="slide-item">
                        ...
                        <div id="bracelet-1" class="tab-pane active show" role="tabpanel">
                            @foreach($bracelet as $shop)
                                <div class="hiraola-product-tab_slider-3">
                                    <!-- Begin Hiraola's Slide Item Area -->
                                    <div class="slide-item">
                        ...
                        <div id="anklet-1" class="tab-pane active show" role="tabpanel">
                            @foreach($anklet as $shop)
                                <div class="hiraola-product-tab_slider-3">
                                    <!-- Begin Hiraola's Slide Item Area -->
                                    <div class="slide-item">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="tab-content hiraola-tab_content">
                        ...
                        <div id="earrings-2" class="tab-pane active show" role="tabpanel">
                            @foreach($earrings as $shop)
                                <div class="hiraola-product-tab_slider-3">
                                    <!-- Begin Hiraola's Slide Item Area -->
                                    <div class="slide-item">
                        ...
                        <div id="bracelet-2" class="tab-pane active show" role="tabpanel">
                            @foreach($bracelet as $shop)
                                <div class="hiraola-product-tab_slider-3">
                                    <!-- Begin Hiraola's Slide Item Area -->
                                    <div class="slide-item">
                        ...
                        <div id="anklet-2" class="tab-pane active show" role="tabpanel">
                            @foreach($anklet as $shop)
                                <div class="hiraola-product-tab_slider-3">
                                    <!-- Begin Hiraola's Slide Item Area -->
                                    <div class="slide-item">
            ...
            <div class="shipping-nav">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="shipping-item">
                            <div class="shipping-icon">
                                <img src="{{asset('front-assets')}}/assets/images/shipping-icon/1.png" alt="Hiraola's Shipping Icon">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="shipping-item">
                            <div class="shipping-icon">
                                <img src="{{asset('front-assets')}}/assets/images/shipping-icon/2.png" alt="Hiraola's Shipping Icon">
                            </div>
                            <div class="shipping-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="shipping-item">
                            <div class="shipping-icon">
                                <img src="{{asset('front-assets')}}/assets/images/shipping-icon/3.png" alt="Hiraola's Shipping Icon">
                            </div>
                            <div class="shipping-content">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="shipping-item">
                            <div class="shipping-icon">
                                <img src="{{asset('front-assets')}}/assets/images/shipping-icon/4.png" alt="Hiraola's Shipping Icon">
                            </div>
                            <div class="shipping-content">
