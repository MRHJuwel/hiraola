                ...
                <div class="col-lg-4">
                    <div class="footer-widgets_info">
                        ...
                        <div class="footer-widgets_logo">
                            <a href="{{route('home')}}">
                                <img src="{{asset('front-assets')}}/assets/images/footer/logo/1.png" alt="Hiraola's Footer Logo">
                            </a>
                        </div>
                                    ...
                                    <div class="widgets-essential_stuff">
                                        <ul>
                                            <li class="hiraola-address"><i
                                                    class="ion-ios-location"></i><span>Address:</span> Co-oparative Market, Mirput-1, at Dhaka 1216, in Bangladesh</li>
                                            <li class="hiraola-phone"><i class="ion-ios-telephone"></i><span>Call
                                                    Us:</span> <a href="tel://+8801689048113">+880 168 9048 113</a>
                                            </li>
                                            <li class="hiraola-email"><i
                                                    class="ion-android-mail"></i><span>Email:</span> <a href="mailto://mdjuwerl016@gmail.com">mdjuwel016@gmail.com</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="footer-bottom_nav">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="payment">
                            <a href="#">
                                <img src="{{asset('front-assets')}}/assets/images/footer/payment/1.png" alt="Hiraola's Payment Method">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-12">
