            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-5">
                    <div class="overview-img text-center img-hover_effect">
                        <a href="#">
                            <img class="img-full" src="{{asset('front-assets')}}/assets/images/about-us/1.jpg" alt="Hiraola's About Us Image">
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="team-area">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 py-2 pb-2">
                    <div class="team-member">
                        <div class="team-thumb img-hover_effect">
                            <a href="#">
                                <img src="{{asset($team->image)}}" alt="Our Team Member">
                            </a>
                        </div>
