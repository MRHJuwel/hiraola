                ...
                <table class="table table-bordered table-hover mb-0">
                    ...
                    <tr>
                        ...
                        <td class="compare-column-productinfo">
                            <div class="compare-pdoduct-image">
                                <a href="{{route('single.product')}}">
                                    <img src="{{asset('front-assets')}}/assets/images/product/medium-size/1-3.jpg" alt="Hiraola's Product Image">
                                </a>
                                <a href="{{route('shop.to.card')}}" class="hiraola-compare_btn">
                        ...
                        <td class="compare-column-productinfo">
                            <div class="compare-pdoduct-image">
                                <a href="{{route('single.product')}}">
                                    <img src="{{asset('front-assets')}}/assets/images/product/medium-size/1-7.jpg" alt="Hiraola's Product Image">
                                </a>
                                <a href="{{route('shop.to.card')}}" class="hiraola-compare_btn">
                                    <span>ADD TO CART</span>
                                </a>
                    ...
                    <tr>
                        <th>Product Name</th>
                        <td>
                            <h5 class="compare-product-name"><a href="{{route('single.product')}}">Toe Rings</a>
                            </h5>
                        </td>
                        <td>
                            <h5 class="compare-product-name"><a href="{{route('single.product')}}">Exquisite Rings</a></h5>
                        </td>
                    </tr>
                    <tr>
                        <th>Description</th>
